...
function FilteredEventPage() {
    ...
    const { data, error } = useSWR('https://test-71e73.firebaseio.com/events.json', fetcher);
    ...
    useEffect(() => {
     ...
     let pageHeadData =  <Head>
                ...
                <meta name="description" content="A list of Event" />
            </Head>
...
//     const event = await getFilteredEvents({
//         year: numYear,
//         month: numMonth
//     });
